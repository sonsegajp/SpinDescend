...
const SFX = {
  ...
  keyblade: A => { SFX.whoosh(A); arp(A, [1568, 2093, 2637, 3136], 0.04, { vol: 0.05, type: 'sine', dur: 0.2 }); },
  gunblade: A => { SFX.slash(A); A.noise(0.26, { vol: 0.55, freq: 1800, q: 0.4, slide: 0.2, delay: 0.05 }); A.tone(80, 0.18, { vol: 0.24, slide: 0.4, delay: 0.05 }); },
  ...
  hylian: A => { SFX.shieldup(A); arp(A, [587, 740, 880, 1175], 0.07, { vol: 0.07, type: 'triangle', dur: 0.4, delay: 0.06 }); },
  ...
  estus: A => { A.noise(0.55, { vol: 0.14, freq: 600, q: 0.8, slide: 2 }); arp(A, [523, 659, 784], 0.1, { vol: 0.07, type: 'triangle', dur: 0.5 }); },
  ...
  fairy: A => { arp(A, [1760, 2093, 2637, 3136, 3520], 0.05, { vol: 0.05, type: 'sine', dur: 0.25 }); arp(A, [660, 880, 1100], 0.08, { vol: 0.07, type: 'triangle', dur: 0.25, delay: 0.3 }); },
  phoenix: A => { A.noise(0.9, { vol: 0.3, freq: 300, q: 0.6, slide: 3 }); arp(A, [392, 523, 659, 784, 1047], 0.09, { vol: 0.08, type: 'square', dur: 0.4, delay: 0.2 }); crackle(A, 12, 0.9); },
