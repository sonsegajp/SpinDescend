...
//   devour   bites twice
export const BOSSES = {
  dungeon: { kind: 'slime_monarch', name: 'The Slime Monarch', title: 'Regal. Consuming. Evergrowing.', hp: 36, atk: 3,
             abilities: ['slam', 'regrow'], gold: [24, 32] },
  mines:   { kind: 'gravemaw', tex: 'bake_gravemaw_deep', tint: [0.66, 0.66, 0.72], name: 'The Deepstone Titan', title: 'Hewn. Buried. Awakened.', hp: 40, atk: 3,
             armor: 1, size: 0.9, abilities: ['slam', 'rebuild'], gold: [26, 36] },
  crypt:   { kind: 'gravemaw', name: 'The Gravemaw Titan', title: 'Ancient. Burdened. Unyielding.', hp: 44, atk: 4, size: 0.9,
             abilities: ['slam', 'drain'], gold: [30, 40] },
  frozen:  { kind: 'slime_monarch', tex: 'bake_slime_monarch_frost', name: 'The Frost Monarch', title: 'Cold. Crowned. Crushing.',
             hp: 44, atk: 3, abilities: ['freeze', 'glacier'], gold: [28, 38] },
  magma:   { kind: 'boar_demon', name: 'The Boar Demon', title: 'Brutal. Feral. Tyrannical.', hp: 42, atk: 4, size: 0.8,
             abilities: ['charge', 'burn'], gold: [30, 40] },
  ruins:   { kind: 'mimic_colossus', tex: 'bake_mimic_colossus_ruin', tint: [0.64, 0.68, 0.64], name: 'The Ruin Colossus', title: 'Weathered. Hollow. Hungry.',
