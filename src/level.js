...
import { rng, trs } from './math.js?v=20260925234051';
import { Batcher } from './gl.js?v=20260925234051';
import { BIOMES, ELITES, biomeForFloor, LAST_FLOOR } from './data.js?v=20260925234051';
