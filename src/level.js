...
import { rng, trs } from './math.js?v=20260925153851';
import { Batcher } from './gl.js?v=20260925153851';
import { BIOMES, ELITES, biomeForFloor, LAST_FLOOR } from './data.js?v=20260925153851';
